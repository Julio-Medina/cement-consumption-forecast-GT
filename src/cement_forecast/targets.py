...
TARGET_CATALOG: tuple[TargetSpec, ...] = (
    ...
    TargetSpec(
        ...
        description="Monthly economic activity index for the construction sector. Add this after parsing Banguat IMAE data.",
        unit="index",
        priority=40,
    ),
    TargetSpec(
        ...
        description="Monthly general economic activity index. Add this after parsing Banguat IMAE data.",
        unit="index",
        priority=41,
    ),
    TargetSpec(
